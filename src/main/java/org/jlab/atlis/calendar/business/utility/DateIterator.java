...
public class DateIterator implements Iterator<Date>, Iterable<Date> {
   ...
   * resolution of {@link java.util.Calendar#DATE}.
   *
   ...
   * resolution.
   *
   * <p>The iteration resolution is specified using calendar field as defined in {@link
   * java.util.Calendar}.
   *
   * @param start the start date.
   * @param end the end date.
  ...
  /**
   * Get the {@link java.util.Calendar} field used as the iterator resolution.
   *
