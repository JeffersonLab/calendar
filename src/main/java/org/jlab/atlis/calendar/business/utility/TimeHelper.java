...
public class TimeHelper {
    ...
    /**
     * Calculates the the number of whole days between two dates.  Hours, 
     * Minutes, seconds, and milliseconds are ignored.
     *
     * Note: this method does not consider daylight savings or TimeZones
     * (Only Calendars work with TimeZones and daylight savings).
     *
