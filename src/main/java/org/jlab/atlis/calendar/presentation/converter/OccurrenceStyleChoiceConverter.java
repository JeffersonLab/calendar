...
public class OccurrenceStyleChoiceConverter {
  ...
  public OccurrenceStyleChoiceConverter() {
    try {
      ...
      oscFacade =
          (OccurrenceStyleChoiceFacade)
              jndiContext.lookup("java:global/calendar/OccurrenceStyleChoiceFacade");
    } catch (NamingException e) {
      throw new RuntimeException(
          "Unable to inject OccurrenceStyleChoiceFacade into OccurrenceStyleChoiceConverter", e);
    }
  }
