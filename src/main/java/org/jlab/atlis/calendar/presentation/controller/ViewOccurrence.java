 ...
 * @author ryans
 */
@WebServlet(name = "ViewOccurrence", urlPatterns = {"/view-occurrence"})
public class ViewOccurrence extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new CalendarException("Unable to view occurrence: Invalid occurrenceId: " + e.getMessage());
        }

        Occurrence occurrence = occurrenceFacade.find(occurrenceId);

        if (occurrence == null) {
            throw new CalendarException("Unable to view occurrence: Unable to locate occurrence with ID = " + occurrenceId);
        }
        ...
        getServletConfig().getServletContext().getRequestDispatcher("/WEB-INF/views/view-occurrence.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            throw new CalendarException("Unable to delete occurrence: Invalid occurrenceId: " + e.getMessage());
        }

        Occurrence occurrence = occurrenceFacade.find(occurrenceId);

        if (occurrence == null) {
            throw new CalendarException("Unable to delete occurrence: Unable to locate occurrence with ID = " + occurrenceId);
        }
