 ...
 * @author ryans
 */
@WebServlet(name = "CopyOccurrence", urlPatterns = {"/copy-occurrence"})
public class CopyOccurrence extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (copy == null) {
            throw new CalendarException("Unable to copy occurrence: Unable to locate occurrence to copy with ID = " + copyId);
        }
        ...
        getServletConfig().getServletContext().getRequestDispatcher("/WEB-INF/views/copy-occurrence.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if((request.getRequestedSessionId() != null && !request.isRequestedSessionIdValid()) || request.getRemoteUser() == null) {
        ...
        if (Objects.equals(calendarId, existingCalendarId)) { // Copy within same Calendar, use existing event
