 ...
 * @author ryans
 */
@WebServlet(name = "SearchAtlis", urlPatterns = {"/search-atlis"})
public class SearchAtlis extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!messages.isEmpty()) {
            ...
            getServletConfig().getServletContext().getRequestDispatcher("/WEB-INF/views/search-atlis.jsp").forward(request, response);
            return;
        }
