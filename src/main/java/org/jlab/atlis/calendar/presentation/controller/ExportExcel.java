...
public class ExportExcel extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Ideally the query would just return completely ordered, but JPA doesn't handle arbitrary sort order on shift column well so
    ...
    private DateRange convertValidateDateRange(HttpServletRequest request) throws ValidationException {
