...
@WebServlet(
    name = "ViewOutlook",
    urlPatterns = {"/view-outlook"})
public class ViewOutlook extends HttpServlet {

  @EJB private EventCalendarManager calendarManager;
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    List<EventCalendarWeek> weeks =
        calendarManager.getOutlookWeeks(calendarId, yearWeek[0], yearWeek[1]);
    ...
    getServletConfig()
        .getServletContext()
        .getRequestDispatcher("/WEB-INF/views/view-outlook.jsp")
