 ...
 * @author ryans
 */
@WebServlet(name = "ViewEvent", urlPatterns = {"/view-event"})
public class ViewEvent extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (event == null) {
            throw new CalendarException("Unable to view event: Unable to locate event with ID = " + eventId);
        }
        ...
        getServletConfig().getServletContext().getRequestDispatcher("/WEB-INF/views/view-event.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (event == null) {
            throw new CalendarException("Unable to delete event: Unable to locate event with ID = " + eventId);
        }
